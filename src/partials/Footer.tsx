      ...
      <footer className="bg-success-subtle text-center text-dark pt-4 pb-4">
        <Container>
          ...
          <Row className="mb-3">
            ...
            <Col xs={6} md={6}>
              <h5 className="footer-font mb-3">Öppettider</h5>
              <p className="footer-font mb-1">Måndag: 17:00-23:00</p>
              <p className="footer-font mb-1">Tisdag-Torsdag: 09:00-23:00</p>
              <p className="footer-font mb-1">Fredag: 09:00-00:00</p>
              <p className="footer-font mb-1">Lördag: 10:00-00:00</p>
              <p className="footer-font mb-1">Söndag: 10:00-23:00</p>
            </Col>
          </Row>
